 ...
 */
public class Layer extends ASetObject implements Cloneable {
     ...
     * @param _h
     */
    public void clobber(float _tx, float _ty, float _w, float _h) {
        tx = _tx;
        ty = _ty;
    }
     ...
     * @return
     */
    public boolean intersection(float _x, float _y, float _w, float _h) {
        float x1 = (x >= _x) ? x : _x;
