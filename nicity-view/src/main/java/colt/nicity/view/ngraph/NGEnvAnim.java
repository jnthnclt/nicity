...
public class NGEnvAnim extends Viewer implements IRPPViewable {
     ...
     *
     */
    public Value<Double> attraction = new Value<>(1d);
    /**
     *
     */
    public Value<Double> repulsion = new Value<>(-2.5d);
    /**
     *
     */
    public Value<Double> gravityFactor = new Value<>(0.01d);
    /**
     *
     */
    public Value<Integer> iterations = new Value<>(new Integer(60));
