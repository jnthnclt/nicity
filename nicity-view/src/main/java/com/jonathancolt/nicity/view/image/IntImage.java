...
import com.jonathancolt.nicity.core.lang.MutableDouble;
import com.jonathancolt.nicity.core.lang.UArray;
import com.jonathancolt.nicity.core.lang.UDouble;
import com.jonathancolt.nicity.core.lang.UInteger;
...
import com.jonathancolt.nicity.view.awt.UAWT;
...
import com.jonathancolt.nicity.view.core.VPrinter;
import com.jonathancolt.nicity.view.core.Viewer;
import com.jonathancolt.nicity.view.interfaces.ICanvas;
import com.jonathancolt.nicity.view.interfaces.IComposite;
...
public class IntImage extends Image implements IPaintable, ImageProducer {
    ...
    public void fill(int[] _pixels) {
        ...
        System.arraycopy(_pixels, 0, pixels, 0, l);
        modified();
    }
     ...
     * @param _radius
     */
    public static void covertToAngles(IOut _, IntImage _image, int _radius) {
        int w = _image.w;
        int h = _image.h;
     ...
     * @param _image
     */
    public static void invert(IOut _, IntImage _image) {
        if (_image == null) {
            return;
        }
        int[] pixels = _image.pixels;
     ...
     * @param _amount
     */
    public static void contrastSimpleAverage(IOut _, IntImage _image, double _amount) {
        if (_image == null) {
            return;
        }
        int[] pixels = _image.pixels;
     ...
     * @param _amount
     */
    public static void contrastSimpleMiddle(IOut _, IntImage _image, double _amount) {
        if (_image == null) {
            return;
        }
        int[] pixels = _image.pixels;
     ...
     * @param _image
     */
    public static void invertAlpha(IOut _, IntImage _image) {
        if (_image == null) {
            return;
        }
        int[] pixels = _image.pixels;
     ...
     * @param _o
     */
    public static void swapChannels(IOut _, IntImage _ai, IntImage _bi, int _r, int _g, int _b, int _a, IntImage _o) {
     ...
     * @param _image
     */
    public static void swapChannels(IOut _, boolean[] _swaps, boolean[] _inverts, IntImage _image) {
        if (_image == null) {
            return;
        }
        int[] pixels = _image.pixels;
    ...
    public static void blurMask(
        ...
        for (int _index = 0; _index < pixelCount; _index++) {
            ...
            for (int s = 0; s < size; s++) {
                ...
                float[] hsb = Color.RGBtoHSB((c2 >> 16) & 0xFF, (c2 >> 8) & 0xFF, (c2) & 0xFF, null);
                hue += hsb[0];
                sat += hsb[1];
                bri += hsb[2];
...
//System.out.println("requestTopDownLeftRightResend");
     ...
     * @return
     */
    public static double sliceRingCorrelation(
     ...
     * @return
     */
    public static double[] maxDeltaSemicircles(
            double[] _results,
            double[] _pieR, double[] _pieG, double[] _pieB,
            int[] _pieNums,
