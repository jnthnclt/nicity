...
import com.jonathancolt.nicity.core.observer.Observable;
...
import com.jonathancolt.nicity.view.interfaces.IObservableSelectionChanges;
...
public class ListController extends AListController implements IListController, IKeyEvents, IObservableSelectionChanges {
    ...
    public IVItem[] getItems() {
        ...
        if ((_items == null || _items.length == 0) && !(filter.toString().isEmpty())) {
