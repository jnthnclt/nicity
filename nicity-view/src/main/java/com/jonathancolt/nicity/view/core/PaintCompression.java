...
import com.jonathancolt.nicity.view.value.VRange;
...
public class PaintCompression {
    ...
    public static boolean event(PaintCompression _compression, int _px, int _py, int _x, int _y, int _w, int _h, int _size) {
        ...
        if (_compression.pointMode == null ? cModeless == null : _compression.pointMode.equals(cModeless)) {
            return false;
        }
        if (_compression.pointMode == null ? cModeX == null : _compression.pointMode.equals(cModeX)) {
        ...
        } else if (_compression.pointMode == null ? cModeY == null : _compression.pointMode.equals(cModeY)) {
