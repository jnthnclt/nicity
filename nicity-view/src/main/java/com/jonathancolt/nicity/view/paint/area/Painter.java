...
import com.jonathancolt.nicity.view.event.AKeyEvent;
...
import com.jonathancolt.nicity.view.paint.lens.LensStack;
...
public class Painter extends VPan implements IMouseMotionEvents, IMouseEvents, IKeyEvents, IMouseWheelEvents {
    ...
    CArray<IPaintableArea> paintables = new CArray<>(IPaintableArea.class);
    /**
     *
     * @param _w
     * @param _h
    ...
    private IPaintableArea[] areas() {
        ...
        IPaintableArea[] areas = paintables.getAll();
        CArray<IPaintableArea> expand = new CArray<>(IPaintableArea.class);
        expand(expand,areas);
        areas = expand.getAll();
    ...
    public void mousePressed(MousePressed _e) {
        ...
        for(IPaintableArea p:pressed) {
            p.mouse(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cPressed,(AMouseEvent)_e,null));
        }
        paint();
    }
    ...
    public void mouseReleased(MouseReleased _e) {
        ...
        for(IPaintableArea r:released) {
            r.mouse(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cReleased,(AMouseEvent)_e,null));
        }
        paint();
    }
    ...
    public void mouseMoved(MouseMoved _e) {
        ...
        CSet<IPaintableArea> set = new CSet<>(over);
        ...
        for(IPaintableArea o:over) {
            o.mouse(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cMoved,(AMouseEvent)_e,null));
        }
        moved = over;
        paint();
    }
    ...
    public void mouseExited(MouseExited _e) {
        ...
        for(IPaintableArea m:moved) {
            m.mouse(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cExited,(AMouseEvent)_e,null));
        }
        paint();
    }
    ...
    public void mouseDragged(MouseDragged _e) {
        ...
        for(IPaintableArea p:pressed) {
            p.mouse(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cDragged,(AMouseEvent)_e,null));
        }
        IPaintableArea[] over = over(_e.getPoint());
        for(IPaintableArea o:over) {
            o.mouse(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cMoved,(AMouseEvent)_e,null));
    ...
    public void keyPressed(KeyPressed e) {
        for(IPaintableArea f:focused) {
            f.key(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cPressed,null,(AKeyEvent)e));
        }
        paint();
    }
    ...
    public void keyReleased(KeyReleased e) {
        for(IPaintableArea f:focused) {
            f.key(new PaintableEvent(lensStack,lx,ly,lw,lh,UPaintableEvent.cReleased,null,(AKeyEvent)e));
        }
        paint();
    }
