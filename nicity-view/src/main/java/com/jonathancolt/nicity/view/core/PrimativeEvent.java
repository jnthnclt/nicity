...
import com.jonathancolt.nicity.view.adaptor.IEventConstants;
import com.jonathancolt.nicity.view.adaptor.IKeyEventConstants;
import com.jonathancolt.nicity.view.event.ADK;
...
public class PrimativeEvent extends ASetObject {
    ...
    public String toString() {
        ...
        s.append(ADK.family[family]).append(" ");
        s.append(ADK.familyID[family][id]).append(" ");
        ...
        if (clickCount > 0) {
            s.append("Click(").append(clickCount).append(") ");
        }
        s.append("Point(").append(x).append(",").append(y).append(",").append(z).append(") ");
        if (keyCode > 0) {
            s.append("Key(").append(keyChar).append(",").append(keyCode).append(") ");
        }
        return s.toString();
    }
