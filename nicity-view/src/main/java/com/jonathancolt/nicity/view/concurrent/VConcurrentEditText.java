package com.jonathancolt.nicity.view.concurrent;
...
import com.jonathancolt.nicity.view.core.Layer;
...
public class VConcurrentEditText extends ViewText implements IFocusEvents, IKeyEvents, IMouseEvents, IMouseMotionEvents {
    ...
    final private CSet<KeyedValue<Long, RowColum>> selectionBegin = new CSet<>();
    final private CSet<KeyedValue<Long, RowColum>> selectionStart = new CSet<>();
    final private CSet<KeyedValue<Long, RowColum>> selectionEnd = new CSet<>();
    final private CSet<KeyedValue<Long, RowColum>> carets = new CSet<>();
