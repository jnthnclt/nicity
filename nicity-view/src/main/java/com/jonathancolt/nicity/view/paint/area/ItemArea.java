...
import com.jonathancolt.nicity.view.flavor.AFlavorCondition;
...
abstract public class ItemArea extends ClickableArea {
    ...
    public AFlavorCondition whenOver(final AFlavor _flavor) {
        return new AFlavorCondition<ItemArea>() {
            ...
            public AFlavor paintFlavor(ItemArea _condition) {
                if (_condition.choosen == null && _condition.over != null) {
                    return _flavor.paintFlavor(_condition);
                }
                return null;
            }
        };
    ...
    public AFlavorCondition whenOverChoosen(final AFlavor _flavor) {
        return new AFlavorCondition<ItemArea>() {
            @Override
            public AFlavor paintFlavor(ItemArea _condition) {
                if (_condition.over != null && _condition.choosen != null) {
                    return _flavor.paintFlavor(_condition);
                }
                return null;
            }
    ...
    public void mouse(PaintableEvent _e) {
        if (_e.mode == null ? UPaintableEvent.cExited == null : _e.mode.equals(UPaintableEvent.cExited)) {
            over = null;
        } else {
            over = _e;
        }
