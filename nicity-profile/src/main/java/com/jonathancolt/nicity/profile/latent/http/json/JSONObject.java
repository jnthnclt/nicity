...
public class JSONObject extends HashMap implements Map, JSONAware, JSONStreamAware {
     ...
     * will be ignored at this top level.
     *
    ...
    /**
     * Convert a map to JSON text. The result is a JSON object. If this map is also a JSONAware, JSONAware specific behaviours will be omitted at this top
     * level.
     *
    ...
    /**
     * Escape quotes, \, /, \r, \n, \b, \f, \t and other control characters (U+0000 through U+001F). It's the same as JSONValue.escape() only for compatibility
     * here.
     *
